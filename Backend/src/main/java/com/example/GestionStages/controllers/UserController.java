...
import com.example.GestionStages.services.EmailService;
...
public class UserController {
    ...
    @Autowired
    public UserController(UserService userService, EmailService emailService, MapperService mapperService) {
    ...
    public ResponseEntity<?> addTuteur(@RequestBody Tuteur tuteur) {
        ...
        if (emailService.sendCredentailsEmail(tuteur, password)) {
    ...
    public ResponseEntity<?> addStagiaire(@RequestBody Stagiaire stagiaire) {
        ...
        if (emailService.sendCredentailsEmail(stagiaire, password)) {
    ...
    public ResponseEntity<?> addAdmin(@RequestBody Admin admin) {
        ...
        if (emailService.sendCredentailsEmail(admin, password)) {
